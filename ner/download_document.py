# Authors: Michal Hradiš, Stefan Weil
# Script for downloading documents from PERO OCR web.
#
# Taken from PERO OCR web Github repository:
# https://github.com/DCGM/pero_ocr_web/blob/master/user_scripts/download_document.py
#
