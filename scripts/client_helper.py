# Authors: Jan Kohút, Petr Buchal, Stefan Weil, Michal Hradiš, David Endrych
# Script for HTTPS communication and log in session handling.
#
# Taken from PERO OCR web Github repository:
# https://github.com/DCGM/pero_ocr_web/blob/master/client_helper.py
#
